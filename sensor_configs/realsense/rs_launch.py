...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.power_line_frequency', 'default': '2', 'description': 'enable/disable Power Line Freq [0,2]'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '640,480,90', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_format',    'default': 'Z16', 'description': 'depth stream format'},
                           {'name': 'depth_module.infra_profile',   'default': '640,480,90', 'description': 'infra streams (0/1/2) profile'},
                           {'name': 'depth_module.infra_format',    'default': 'RGB8', 'description': 'infra0 stream format'},
                           {'name': 'depth_module.infra1_format',   'default': 'Y8', 'description': 'infra1 stream format'},
                           {'name': 'depth_module.infra2_format',   'default': 'Y8', 'description': 'infra2 stream format'},
                           {'name': 'depth_module.color_profile',   'default': '640,480,90', 'description': 'Depth module color stream profile for d405'},
                           ...
                           {'name': 'depth_module.inter_cam_sync_mode',               'default': "4", 'description': '[0-Default, 1-Master, 2-Slave]'},
                           ...
                           {'name': 'accel_fps',                    'default': '250', 'description': "'63,250'"},
